...
const { handleProfileUploadEvent,handleTeamDetailEvent,handleTeamDetailForMatchInviteEvent,handleTeamDetailForRespondingToInviteEvent } = require('./eventHandlers/identity-event-handlers')
...
const startServer = async () => {
  try {
    ...
    await consumeEvent('profilePhoto.updated',handleProfileUploadEvent);
    await consumeEvent('fetchTeamDetails',handleTeamDetailEvent);
    await consumeEvent('fetchTeamDetailsForMatchInviteCreated',handleTeamDetailForMatchInviteEvent);
    await consumeEvent('fetchTeamDetailsForRespondingToInvite',handleTeamDetailForRespondingToInviteEvent);

    // await consumeEvent('team.d.created',handleInviteDetailRequestedEvent);
